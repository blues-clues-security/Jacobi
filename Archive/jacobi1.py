  ...
  'options':[
    { 'title': "Characterization of Network Bandwidth Usage", 'type': MENU, 'subtitle': "Please select an option...",
      'options': [
        ...
        { 'title': "No title", 'type': COMMAND, 'command': 'clear && google-chrome yourealoser.net &' },
        { 'title': "No title", 'type': COMMAND, 'command': 'dosbox /media/samba/Apps/dosbox/doswin/games/SST/SST.EXE -exit' },
        ]
        },
...
def iplist():
  print('\n')
  ip_range = input('Place an input here: ')
  print('\n')
  print ip_range
